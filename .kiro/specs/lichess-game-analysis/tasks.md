...
- [ ] 2. Implementar gestión de credenciales
  - [ ] 2.1 Implementar clase `GestorCredenciales`
  ...
  - [ ]* 2.2 Escribir pruebas basadas en propiedades para credenciales
  ...
  - [ ]* 2.3 Escribir pruebas basadas en propiedades para round-trip de almacenamiento
  ...
  - [ ] 2.4 Implementar validación de credenciales
...
- [ ] 3. Implementar componente de configuración de credenciales
  - [ ] 3.1 Crear componente `ConfiguraciónCredenciales`
  ...
  - [ ] 3.2 Implementar lógica de guardado y validación en componente
  ...
  - [ ] 3.3 Agregar botón de acceso a configuración desde menú principal
...
- [ ] 5. Implementar cliente de Lichess API
  - [ ] 5.1 Crear clase `ClienteLichess`
  ...
  - [ ] 5.2 Implementar método `validarToken()`
  ...
  - [ ] 5.3 Implementar método `obtenerCuentaUsuario()`
  ...
  - [ ] 5.4 Implementar método `obtenerÚltimaPartida()`
  ...
  - [ ] 5.5 Implementar manejo de errores específicos de Lichess
  ...
  - [ ]* 5.6 Escribir pruebas de integración para `ClienteLichess`
...
- [ ] 6. Integrar validación de token en configuración
  - [ ] 6.1 Conectar validación de token con UI de configuración
